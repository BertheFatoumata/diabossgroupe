    ...
    <div class="topbar d-flex align-items-center dark-background"
      ...
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:diabossconstruction@gmail.com"><span >diabossgroupe@gmail.com</span></a></i>
          <i class="bi bi-phone d-flex align-items-center ms-4"><span>+223 60 55 55 89 / +223 75 44 71 13</span></i>
        </div>
