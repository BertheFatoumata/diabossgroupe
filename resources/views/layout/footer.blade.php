    ...
    <div class="container">
        ...
        <div class="contact-grid">
            <div class="contact-card" style="background:rgba(255,255,255,0.04); border-color:rgba(255,255,255,0.14);">
                ...
                <div class="row"><strong>E-mail</strong><span><a href="mailto:diabossgroupe@gmail.com">
            ...
            <form class="contact-form" action="{{ route('envoyer.email') }}" method="POST">
                ...
                <div>
                    ...
                    <textarea id="message" name="message" rows="4" placeholder="Parlez-nous de votre projet..." required></textarea>
                </div>
...
<footer class="site-footer">
    <div class="container">
        <div>
            ...
            <p style="margin-top:14px; max-width:32ch;">Sept entreprises, une seule chaîne de valeur : de la terre au
                toit.</p>
        </div>
        <div>
            <h4>Nos filiales</h4>
    ...
    <div class="container foot-bottom">
        ...
        <samp>
            <div class="social-links">
                ...
                <a href="https://www.facebook.com/TeamsDiaboss" class="facebook" target="_blank">
                    <i class="bi bi-facebook"></i>
                </a>

                <a href="https://www.instagram.com/diabossgroupe?utm_source=qr&igsh=eW9vNnUwdWNsa3Z6" class="instagram"
                    target="_blank">
                    <i class="bi bi-instagram"></i>
                </a>

                <a href="https://vm.tiktok.com/ZS9kbxF7eMSNC-EYifW/" class="tiktok" target="_blank">
